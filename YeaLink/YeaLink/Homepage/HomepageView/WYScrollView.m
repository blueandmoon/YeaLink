...
- (void)changeImageLeft:(NSInteger)LeftIndex center:(NSInteger)centerIndex right:(NSInteger)rightIndex
{
    if (_isNetworkImage)
    {
        ServiceModel *leftModel = _imageArray[LeftIndex];
        ServiceModel *centerModel = _imageArray[centerIndex];
        ServiceModel *rightModel = _imageArray[rightIndex];
        
        [_leftImageView sd_setImageWithURL:[NSURL URLWithString:leftModel.IconPath] placeholderImage:PLACEIMAGE];
        [_centerImageView sd_setImageWithURL:[NSURL URLWithString:centerModel.IconPath] placeholderImage:PLACEIMAGE];
        [_rightImageView sd_setImageWithURL:[NSURL URLWithString:rightModel.IconPath] placeholderImage:PLACEIMAGE];
