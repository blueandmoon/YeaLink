...
- (void)readConfigCallBack:(DHBleResultType)result advInt:(UInt16)advTime connectInt:(UInt16)connectTime txPower:(Byte)power activeTime:(UInt16)actTime;
...
-(DHBleErrorType)configDevice:(CBPeripheral *)peripheral deviceNum:(UInt32)deviceId devicePassword:(UInt32)password advInt:(UInt16)advTime connectInt:(UInt16)connectTime txPower:(Byte)power activeTime:(UInt16)actTime;
